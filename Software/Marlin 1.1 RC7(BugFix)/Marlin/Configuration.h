...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define  DEFAULT_Kd 440
	...
	// CoreXY Custom PID Settings - Hotend
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define  DEFAULT_bedKd 1675.16
	...
	// CoreXY Custom PID Settings - Heatbed with borosilicate glass
...
#define INVERT_E0_DIR true //false // was false for old extruder
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 165//((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.58,80.58,408.4,416.6}  // custom steps per unit for CoreXY //Eo: 104.5
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {225, 225, 3, 25}    // (mm/sec) custom for CoreXY
//#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_MAX_ACCELERATION      {1000,1000,100,10000}    // Custom for CoreXY

//#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_ACCELERATION          800    // Custom for CoreXY
